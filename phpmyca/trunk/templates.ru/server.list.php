...
// footer links
$l = array();
$this->addMenuLink($qs_sign,'Генерация серт-та из CSR','greenoutline');
$this->addMenuLink($qs_imp,'Импорт серверного серт-та','greenoutline');
$this->addMenuLink($qs_add,'Создать серверный серт-т','greenoutline');
if ($list->hitsTotal > 0) {
	$this->addMenuLink($qs_export,'Загрузить все серт-ты','greenoutline');
	}
